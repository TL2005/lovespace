function updateTimer1() {
    ...
    document.getElementById('time1').innerText = `${days}天${hours}小时${minutes}分${seconds}秒`;
}
function updateTimer2() {
    ...
    const minutes = Math.floor((diff / 1000 / 60) % 60);
    const seconds = Math.floor((diff / 1000) % 60);
    document.getElementById('time2').innerText = `${days}天${hours}小时${minutes}分${seconds}秒`;
}
